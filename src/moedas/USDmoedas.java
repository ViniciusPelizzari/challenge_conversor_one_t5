...
public class USDmoedas extends USD{
    ...
    //passa a listagem para o construtor da interface
    ...
    //metodo de execucao -> chama metodo conforme captura do botao usuario
    public void Exe() {
        USD usd = new USD();
        ...
        if (escolhaUSD.equals("USD to BRL")) {
            ...
            usd.setValorC(String.valueOf(usd.getValorConvertido()));
            new ImprimirFrameMoeda("VALOR", "VALOR CONVERTIDO DE " + Double.parseDouble(quantia) + " USD é: " + usd.getValorC() + " GBP");
